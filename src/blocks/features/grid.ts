...
const htmlCode = `<section class="py-20">
    <div class="mx-auto max-w-5xl space-y-16 px-6">
        <div class="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
            <h2 class="text-title text-balance text-4xl font-medium lg:text-5xl">The foundation for creative teams management</h2>
        ...
        <div class="relative mx-auto grid max-w-4xl divide-x divide-y border *:p-12 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="space-y-2">
                ...
                <p class="text-body text-sm">It supports an helping developers businesses.</p>
            </div>
            <div class="space-y-2">
                <div class="flex items-center gap-2">
                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <h3 class="text-title text-sm font-medium">Customization</h3>
                </div>
        ...
        <section className="py-20">
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
                    <h2 className="text-title text-balance text-4xl font-medium lg:text-5xl">The foundation for creative teams management</h2>
                ...
                <div className="relative mx-auto grid max-w-4xl divide-x divide-y border *:p-12 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-body text-sm">It supports an helping developers businesses.</p>
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            <svg className="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <h3 className="text-title text-sm font-medium">Customization</h3>
                        </div>
